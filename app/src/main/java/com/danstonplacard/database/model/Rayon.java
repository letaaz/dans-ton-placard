...
public enum Rayon {
    ...
    ANIMAUX,BIO,BOISSONS,BOULANGERIE_PATISSERIE,CREMERIE,DIVERS,
    EPICERIE_SALEE, EPICERIE_SUCREE, FROMAGES, FRUITS_LEGUMES, HYGIENES_BEAUTES, POISSONS_CRUSTACES,
    SURGELE, VIANDES, YAOURTS_DESSERTS;
